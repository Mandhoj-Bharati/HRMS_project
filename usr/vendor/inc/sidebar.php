<?php
        ...
        ?>
            <ul class="sidebar navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="usr-book-house.php">
                      <i class="fas fa-fw fa-home"></i>
                      <span>Houses</span>
                    </a>
                    <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                      <h6 class="dropdown-header">Available Houses:</h6>
                      <a class="dropdown-item" href="usr-book-house.php">Book</a>
                    </div>
                  </li>
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                      ...
                      <!-- <a class="dropdown-item" href="usr-book-house.php">Add</a> -->
