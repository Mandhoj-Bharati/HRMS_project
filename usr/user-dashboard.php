        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-primary o-hidden h-100">
              <div class="card-body">
                <div class="card-body-icon">
                  <i class="fas fa-fw fa-clipboard"></i> <i class="fas fa-fw fa-home"></i>
                </div>
                <div class="mr-5">Book House</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="usr-book-house.php">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <?php
                  ...
                  $ret="SELECT * FROM tms_house "; //get all bookings
                ...
                ?>
                  <tr>
                    ...
                    <!-- <img src="vendor/img/<?php echo $row->h_dpic;?>" alt=""> -->
                    <td> <img src="vendor/img/<?php echo $row->h_dpic;?>"width="100px"></td>
                    <!-- <td><?php echo $row->h_dpic;?></td> -->
