  ...
  if(isset($_POST['update_profile']))
    {
            ...
            // $u_cpic=$_FILES["u_cpic"]["name"];
            // move_uploaded_file($_FILES["u_cpic"]["tmp_name"],"../vendor/img/".$_FILES["u_cpic"]["name"]);
      ...
      <?php if(isset($succ)) {?>
        ...
        ?>
          <form method ="POST"> 
            ...
            <img src="../vendor/img/<?php echo $row->u_cpic;?>" class="card-img-top" >
            <div class="card-body">
                <h5 class="card-title">Add Citizenship</h5>
