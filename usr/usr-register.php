  ...
  if(isset($_POST['add_user']))
    {
            ...
            $query="insert into tms_user (u_fname, u_lname, u_phone, u_addr, u_category, u_email, u_pwd,u_cpic) values(?,?,?,?,?,?,?,?)";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('ssssssss', $u_fname,  $u_lname, $u_phone, $u_addr, $u_category, $u_email, $u_pwd, $u_cpic);
            $stmt->execute();
                if($stmt)
                {
...
<head>
  ...
  <title>House Managemennt System Client- Register</title>
      ...
      <div class="card-body">
        ...
        <form method = "post">
          ...
          <div class="form-group col-md-12">
                <label for="exampleInputEmail1">Add Citizenship</label>
                <input type="file" class="btn btn-success" id="exampleInputEmail1" name="u_cpic">
            </div>
        ...
        <div class="text-center">
          ...
          <!-- <a name="login"href=mailverify.php>Send OPT code?</a> -->
