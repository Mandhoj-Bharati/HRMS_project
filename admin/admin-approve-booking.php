  ...
  if(isset($_POST['approve_booking']))
    {
           ...
           //$u_car_regno  = $_POST['u_car_regno'];
            ...
            $query="update tms_user set  u_house_book_status=? where u_id=?";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('si',  $u_house_book_status, $u_id);
            $stmt->execute();
                if($stmt)
                {
      ...
      <?php if(isset($succ)) {?>
        ...
        ?>
          <form method ="POST"> 
            ...
            <div class="form-group">
                <label for="exampleInputEmail1">House Category</label>
                <input type="email" readonly value="<?php echo $row->u_house_type;?>" class="form-control" name="u_house_type">
            </div>

            <div class="form-group">
                <label for="exampleInputEmail1"> Rent Amount</label>
                <input type="email" readonly value="<?php echo $row->u_rent_amount;?>" class="form-control" name="u_house_category">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Booking Date</label>
                <input type="text" readonly value="<?php echo $row->u_house_bookdate;?>" class="form-control" id="exampleInputEmail1"  name="u_house_bookdate">
            </div>

            <div class="form-group">
              <label for="exampleFormControlSelect1">Booking Status</label>
              <select class="form-control" name="u_house_book_status" id="exampleFormControlSelect1">
            ...
            <img src="vendor/img/<?php echo $row->u_cpic;?>"width="500px">
