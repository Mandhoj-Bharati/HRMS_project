...
<!--End Navigation-->
  ...
  <header>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url('house pic/h5.jpg')">
        </div>
        <!-- Slide Two - Set the background image for this slide in the line below -->
        <div class="carousel-item" style="background-image: url('house pic/house.jpg')">
        </div>
        <!-- Slide Three - Set the background image for this slide in the line below -->
        <div class="carousel-item" style="background-image: url('house pic/hh9.jpg')">
        </div>
  ...
  <div class="container">
    ...
    <h1 class="my-4">Welcome to House Rental Management System</h1>
    ...
    <div class="row">
      <div class="col-lg-6 mb-4">
        <div class="card h-100">
          ...
          <div class="card-body">
            <p class="card-text">An online House Rental system offers convenience and accessibility, allowing users to search, compare, and book rental properties easily from anywhere at any time.
